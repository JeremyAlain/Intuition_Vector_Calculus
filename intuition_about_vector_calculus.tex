...
\begin{document}
	\maketitle
	\tableofcontents
	\let\thefootnote\relax\footnote{The content is mainly a summary of different websites(mainly http://mathinsight.org/). Sometimes sentences are cited one-to-one, but I have refrained from making citations and a bibliography because this paper's goal is not to be published but for private use.}
	\newpage
	...
	\\ $\textit{A very easy interpretation is to imagine the amount of work that a foce field does on a particle as it moves along a curve.}$
